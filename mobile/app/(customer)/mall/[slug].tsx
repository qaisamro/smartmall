...
export default function MallDetailsScreen() {
        ...
        <View style={[styles.productCard, { backgroundColor: colors.card }]}>
          ...
          >
            <View style={[styles.productImageFrame, { backgroundColor: colors.secondary }]}>
              ...
              <View style={[styles.availabilityBadge, { backgroundColor: colors.card }]}>
          ...
          <View style={styles.productFooter}>
            ...
            <Pressable
              ...
              style={({ pressed }) => [
                styles.addButton,
                {
                  backgroundColor: hasDiscount ? colors.primary : colors.muted,
            ...
            >
              <Feather
                name="plus"
                size={19}
                color={hasDiscount ? colors.primaryForeground : colors.foreground}
              />
            </Pressable>
          </View>
        </View>
  ...
  const coverUrl = normalizeImageUrl(mall.cover_image || mall.logo);
...
const styles = StyleSheet.create({
  ...
  listHeader: { gap: 14, paddingTop: 16 },
  mallHero: {
    height: 208,
    marginHorizontal: 0,
    borderRadius: 17,
  ...
  productsRow: { justifyContent: 'space-between', marginBottom: 12 },
  productCard: {
    width: '48.5%',
    borderRadius: 17,
    padding: 10,
  ...
  availabilityText: { fontFamily: 'Inter_600SemiBold', fontSize: 9 },
  productInfo: { paddingHorizontal: 2, paddingTop: 9 },
  productLabelRow: { minHeight: 36, gap: 2 },
  productName: { fontFamily: 'Inter_700Bold', fontSize: 12, lineHeight: 17, textAlign: 'right' },
  productBrand: { fontFamily: 'Inter_500Medium', fontSize: 9, lineHeight: 13, textAlign: 'right' },
  productFooter: {
    paddingHorizontal: 2,
    paddingTop: 7,
    flexDirection: 'row',
  ...
  priceGroup: { flexDirection: 'row', alignItems: 'baseline', gap: 5, flex: 1 },
  ...
  addButton: { width: 33, height: 33, borderRadius: 9, alignItems: 'center', justifyContent: 'center' },
