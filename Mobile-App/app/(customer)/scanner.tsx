...
import { formatProductPrice, getProductMetadata } from '@/src/utils/productPresentation';
...
export default function ScannerScreen() {
  ...
  const addScannedProductToCart = () => {
    ...
    const productMetadata = getProductMetadata(scannedProduct);
    addItem({
          ...
          {isProcessing ? (
            ...
            <>
              ...
              <Text style={styles.productPrice}>
                {formatProductPrice(scannedProduct, i18n.language.startsWith('ar'))}
              </Text>
