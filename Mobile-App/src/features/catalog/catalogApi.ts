...
import type { Product, Offer, HomeBanner, PaginatedResponse } from '@/src/types/api';
...
export async function getHomeBanners(
  ...
  return (await apiClient.get<HomeBanner[]>('/home-banners', { params: { placement }, signal })).data;
}
