                ...
                <div className="order-2 sm:order-1 space-y-3">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex gap-1 bg-white/5 p-1 rounded-2xl border border-white/5">
                            {['all', 'mall', 'supermarket', 'grocery', 'butcher'].map(t => (
                                <button key={t} onClick={() => setTypeFilter(t)}
                                    ...
                                    {t === 'all' ? 'الكل' : STORE_TYPE_LABELS[t]}
                                </button>
                            ))}
                        </div>
                    </div>
                    <p className="text-gray-400 mt-1">{typeFilter === 'all' ? 'عرض جميع المنشآت المسجلة' : `عرض ${STORE_TYPE_LABELS[typeFilter]}`}</p>
                </div>
            </header>
                ...
                {isLoading ? (
                    ...
                    <div className="col-span-full py-20 text-center text-gray-500 glass-card rounded-3xl border border-white/5">
                        ...
                        <p className="font-bold text-lg">
                            {typeFilter === 'all' ? 'لا توجد أي منشآت مسجلة حالياً' : `لا توجد ${STORE_TYPE_LABELS[typeFilter]} مسجلة`}
                        </p>
                    </div>
                ) : (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <div className="flex flex-col gap-1.5">
                                    ...
                                    <span className={`px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider ${mall.type === 'butcher' ? 'bg-rose-500/10 text-rose-400 border border-rose-500/20' : mall.type === 'grocery' ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/20' : mall.type === 'supermarket' ? 'bg-amber-500/10 text-amber-400 border border-amber-500/20' : 'bg-blue-500/10 text-blue-400 border border-blue-500/20'}`}>
                                        {STORE_TYPE_LABELS[mall.type] || STORE_TYPE_LABELS.mall}
                                    </span>
                                </div>
                            </div>
                    ...
                    <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-0 sm:p-4 bg-black/80 backdrop-blur-sm">
                        ...
                        >
                            ...
                            <h3 className="text-xl sm:text-2xl font-bold mb-1 text-right">
                                {editingMall
                                    ? `تعديل بيانات ${STORE_TYPE_LABELS[formData.type] || STORE_TYPE_LABELS.mall}`
                                    : `إضافة ${STORE_TYPE_LABELS[formData.type] || STORE_TYPE_LABELS.mall} جديد`}
                            </h3>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        >
                                            ...
                                            <option value="butcher">ملحمة</option>
                                        </select>
                                    </div>
                                    <div>
