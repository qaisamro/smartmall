...
const emptyForm = {
    name_ar: '', price: '', category_id: '', section_id: '', barcode: '', link_photo: '',
    stock_quantity: '', shelf_location: '', unit_type: '', pricing_type: '', weight: '',
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5" onClick={e => e.stopPropagation()}>
                                ...
                                <div className="rounded-2xl border border-emerald-500/15 bg-emerald-500/5 p-4 space-y-4">
                                    ...
                                    <div className="grid sm:grid-cols-3 gap-3">
                                        <div>
                                            <label className="block text-xs font-semibold text-gray-400 mb-1.5">الوحدة</label>
                                        ...
                                        <div>
                                            <label className="block text-xs font-semibold text-gray-400 mb-1.5">نوع التسعير</label>
                                        ...
                                        <div>
                                            <label className="block text-xs font-semibold text-gray-400 mb-1.5">الوزن</label>
                                    ...
                                    <div className="grid sm:grid-cols-3 gap-3">
                                        <div>
                                            <label className="block text-xs font-semibold text-gray-400 mb-1.5">نوع القطعة</label>
                                        ...
                                        <div>
                                            <label className="block text-xs font-semibold text-gray-400 mb-1.5">التحضير</label>
                                        ...
                                        <div>
                                            <label className="block text-xs font-semibold text-gray-400 mb-1.5">ملاحظات</label>
