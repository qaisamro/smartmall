...
import { Appearance, Platform, Pressable, RefreshControl, ScrollView, StyleSheet, Text, View, useColorScheme } from 'react-native';
...
export default function ProfileScreen() {
  ...
  const selectedTheme = themeOverride ?? (systemScheme === 'dark' ? 'dark' : 'light');
  ...
  if (profileQuery.isLoading && !profile) {
    return (
      <View style={[styles.screen, { backgroundColor: colors.background, paddingTop: insets.top }]}>
        ...
        <ReferenceBottomNav activeTab="profile" />
      </View>
    );
  }
