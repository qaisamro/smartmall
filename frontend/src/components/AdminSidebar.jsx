...
import {
    ...
    X, Store, ChevronDown, ChevronLeft, Activity, Megaphone, Bell, LogOut, Settings, LayoutPanelTop
} from 'lucide-react';
...
const sections = [
    ...
    },
    {
        ...
        items: [
            ...
            { to: '/admin/home-banners', label: 'بنرات الصفحة الرئيسية', icon: LayoutPanelTop },
